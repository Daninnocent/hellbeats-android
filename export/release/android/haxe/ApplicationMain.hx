...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("hellbeats", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("hellbeats", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "hellbeats";
		app.meta["name"] = "Friday Night Funkin' Hellbeats";
		app.meta["packageName"] = "com.hdboye.hellbeats";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin' Hellbeats",
			width: 1280,
			x: null,
			y: null,
		};
